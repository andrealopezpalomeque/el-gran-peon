...
import { listSubscribers, markAsContacted, bulkMarkAsContacted, deleteSubscriber, bulkDeleteSubscribers } from '../controllers/subscriberController.js';
...
router.post('/bulk-delete', requireAuth, bulkDeleteSubscribers);
