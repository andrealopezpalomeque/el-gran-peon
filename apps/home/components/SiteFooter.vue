      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div class="flex flex-col gap-3">
            <a
              href="https://wa.me/543794007759"
              target="_blank"
              rel="noopener noreferrer"
              class="font-sans text-sm text-brand-cream/70 hover:text-brand-cream transition-colors flex items-center gap-2"
            >
            ...
            <div class="flex items-center gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="text-brand-cream/70 hover:text-brand-cream transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@el.gran.peon?_r=1&_t=ZS-93hJQu94OHc"
                target="_blank"
                rel="noopener noreferrer"
                class="text-brand-cream/70 hover:text-brand-cream transition-colors"
                aria-label="TikTok"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61585645292227&locale=es_LA"
                target="_blank"
                rel="noopener noreferrer"
                class="text-brand-cream/70 hover:text-brand-cream transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://www.linkedin.com/search/results/all/?heroEntityKey=urn%3Ali%3Aorganization%3A101341900&keywords=El%20Gran%20Peon&origin=ENTITY_SEARCH_HOME_HISTORY&sid=!Gv"
                target="_blank"
                rel="noopener noreferrer"
                class="text-brand-cream/70 hover:text-brand-cream transition-colors"
                aria-label="LinkedIn"
            ...
            <a
              href="mailto:info@elgranpeon.com"
              class="font-sans text-sm text-brand-cream/70 hover:text-brand-cream transition-colors flex items-center gap-2"
            >
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="square" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              elgranpeon98@gmail.com
            </a>
          </div>
        </div>
      </div>
