...
const badgeClass = computed(() => {
  ...
  const statusMap = {
    ...
    en_conversacion: 'bg-yellow-100 text-yellow-800 border border-yellow-300',
    confirmado: 'bg-indigo-100 text-indigo-800 border border-indigo-300',
    pagado: 'bg-green-100 text-green-800 border border-green-300',
    enviado: 'bg-purple-100 text-purple-800 border border-purple-300',
